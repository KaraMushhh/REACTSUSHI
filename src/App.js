...
class App extends Component {
    state = {
      cards : [
         ...
         {id:1, nome: "Dragon", prezzo: 3.99, immagine: dragon,quantità: 0 },
         ...
         {id:4, nome: "Rainbow", prezzo: 1.59, immagine: rainbow,quantità: 0 },
         {id:5, nome: "Shrimp", prezzo: 1.89, immagine: shrimp,quantità: 0 },
      ] }
